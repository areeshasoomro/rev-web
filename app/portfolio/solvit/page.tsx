...
//                 {/* Dual Brand Logos Row - Fully Responsive using clamp for smooth mobile scaling */}
//                 <div style={{ 
//                     display: 'flex', 
//                     alignItems: 'center', 
...
//                     marginBottom: '30px',
//                     flexWrap: 'nowrap', // Keeps them on the same line across mobile and desktop
//                     width: '100%',
//                     padding: '0 10px',
//                     maxWidth: '100%',
//                     overflow: 'hidden'
            ...
            <div className={styles.heroCenterContent}>
                ...
                <div style={{ 
                    ...
                    <div style={{ 
                        ...
                        <Image 
                            src={isLightMode ? "/solvit-light.png" : "/solvit logo.png"} 
                            alt="Solvit LMS" 
                            fill 
                            style={{ objectFit: 'contain' }} 
                        />
