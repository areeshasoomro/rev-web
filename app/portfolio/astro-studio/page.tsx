...
export default function AstroPage() {
    ...
    return (
        <main className={styles.mainContainer}>
            ...
            {/* Hero Section */}
            <div className={styles.heroCenterContent}>
                {/* Dual Brand Logos Row - Fully Responsive with Red Glow Behind Both Logos */}
                <div style={{ 
                    display: 'flex', 
                    alignItems: 'center', 
                    ...
                    <div style={{ 
                        ...
                        <Image 
                            src={isLightMode ? "/rev-logo.png" : "/loogo.png"} 
                            alt="Revaya" 
                            fill 
                    ...
                    <div style={{ 
                        ...
                        <Image 
                            src={isLightMode ? "/astro-light.png" : "/astro logo.png"} 
                            alt="Astro Studio" 
                            fill 
                            style={{ objectFit: 'contain' }} 
                            priority
                ...
                {/* Description */}
                <p className={styles.description}>
                    We partnered with Astro Studio to build a high-performance digital platform that reflects their premium brand and simplifies customers' journey from service discovery to booking[cite: 1].
                </p>
