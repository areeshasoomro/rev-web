...
const images = [ '/rujhan1.png', '/rujhan2.png', '/rujhan3.png', '/rujhan4.png'];

export default function RujhanScreenshotSlider() {
                ...
                <div className={styles.carouselContainer}>
                    {images.map((img, i) => {
                        ...
                        return (
                            ...
                            >
                                <img src={img} alt="Rujhan Project Screenshot" className={styles.slideImage1} />
                            </motion.div>
                        );
                    })}
                </div>
