...
export const MyWorkSection: React.FC = () => {
  ...
  return (
    <section id="my-work" className={styles.container}>
      ...
      <div className={styles.exploreCtaContainer}>
        <Link href={`/portfolio/${myWorkData[currentIndex].slug}`} className={styles.exploreCtaButton}>
          <span className={styles.exploreCtaText}>Explore Portfolio</span>
          <span className={styles.exploreCtaIcon}>
