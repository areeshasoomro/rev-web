  ...
  return (
    <section className={styles.container}>
      ...
      <p className={styles.quoteText}>
        SolvIt completely transformed how students interact with course material. The platform looks stunning, navigation is seamless, and our engagement metrics have never been higher.
      </p>

      {/* 3. Branding (Vertically stacked inside its own box to keep alignment) */}
      <div className={styles.authorContainer}>
        <div className={styles.brandName}>
          <span className={styles.brandStudio1}>SOLVIT</span>
        </div>
        <p className={styles.authorTitle}>— Product Lead, SOLVIT</p>
      </div>
    </section>
  );
};

export default Testimonial_solvit;