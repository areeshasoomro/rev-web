  ...
  return (
    <section className={styles.container}>
      ...
      <p className={styles.quoteText}>
        Rujhan has completely revolutionized how we track our textile inventory and production pipeline. Managing multi-vendor orders across weaving, dyeing, and embroidery has never been this seamless and precise.
      </p>

      {/* 3. Branding (Vertically stacked inside its own box to keep alignment) */}
      <div className={styles.authorContainer}>
        <div className={styles.brandName}>
          <span className={styles.brandStudio1} style={{ color: '#20b2aa' }}>RUJHAN</span>
        </div>
        <p className={styles.authorTitle}>— Operations Lead, RUJHAN</p>
      </div>
    </section>
  );
};

export default Testimonial_rujhan;